...
// Checkin $Date: January 4, 2011   10:10:25 $
//###########################################################################
//
// FILE:   F2806x_EQep.c
//
...
void InitEQep(void)
{
	 //--------------------------------------------------------------------------------------
	   	   //////////////////////////////////////////
	      	  ///EQEP CONFIGURATION
	   	   //////////////////////////////////////////
		  EQep1Regs.QUPRD=80000000;         // Unit Timer for 1Hz at 80 MHz SYSCLKOUT
		  EQep1Regs.QDECCTL.bit.QSRC=00;  // QEP quadrature count mode
		  EQep1Regs.QEPCTL.bit.FREE_SOFT=2;
		  EQep1Regs.QEPCTL.bit.PCRM=01;       // PCRM=01 mode - QPOSCNT reset on MAX
		  EQep1Regs.QEPCTL.bit.UTE=1;         // Unit Timeout Enable
		  EQep1Regs.QEPCTL.bit.QCLM=0;        // Latch on counting event
		  EQep1Regs.QPOSMAX=0xFFFFFFFF;		//4096 counts
		  EQep1Regs.QEPCTL.bit.QPEN=1;        // QEP enable
		  EQep1Regs.QCAPCTL.bit.UPPS=1;       // for unit position
		  EQep1Regs.QCAPCTL.bit.CCPS=1;       // for CAP clock
		  EQep1Regs.QCAPCTL.bit.CEN=1;        // QEP Capture Enable


		  EQep2Regs.QUPRD=80000000;         // Unit Timer for 100Hz at 80 MHz SYSCLKOUT
		  EQep2Regs.QDECCTL.bit.QSRC=00;  // QEP quadrature count mode
		  EQep2Regs.QEPCTL.bit.FREE_SOFT=2;
		  EQep2Regs.QEPCTL.bit.PCRM=01;       // PCRM=01 mode - QPOSCNT reset on MAX
		  EQep2Regs.QEPCTL.bit.UTE=1;         // Unit Timeout Enable
		  EQep2Regs.QEPCTL.bit.QCLM=0;        // Latch on counting event
		  EQep2Regs.QPOSMAX=0xFFFFFFFF;		//4096 counts
		  EQep2Regs.QEPCTL.bit.QPEN=1;        // QEP enable
		  EQep2Regs.QCAPCTL.bit.UPPS=1;       // 1/32 for unit position
