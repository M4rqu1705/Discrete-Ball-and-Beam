...
// Checkin $Date: January 4, 2011   10:10:23 $
//###########################################################################
//
// FILE:   F2806x_EPwm.c
//
...
#define PWM_CLK   9765//para lograr un contador hasta 4096 10e3              // estaba en 5kHz (300rpm) EPWM1 frequency. Freq. can be changed here
...
void initEpwm()
{
	...
	EPwm1Regs.ETSEL.all=0x00;      // Interrupt on PRD ESTABA EN 0x0A, DEHABILITA INTERRUPCIONES
